...
<template>
  ...
  >
    <v-container class="description">
      <v-container
        class="description__main"
      >
        <h1>Pedro Augusto Müller</h1>
        <h3>Fullstack Developer</h3>
        <h1>
          <a
            class="description__main__social"
            target="_blank"
      ...
      <v-container class="description__anchors">
        ...
        <a href="#experience" class="description__anchors__text">
          <span>~ </span>
          <span>experiences</span>
        </a>
        <a href="#projects" class="description__anchors__text">
          <span>~ </span>
          <span>projects</span>
        </a>
      </v-container>
...
@media only screen and (max-width: 768px) {
  .description-wrapper {
    ...
    height: fit-content;
    max-height: 100vh;
    border-bottom: 0.3em solid var(--base-text);
    background-color: transparent;
  }
  .social {
    color: var(--base-text);
...
@media only screen and (min-width: 768px) {
  ...
  .description-wrapper {
    border-right: .3em solid var(--card-border);
    border-bottom: 0;
    position: sticky;
    display: flex;
    width: 50%;
